...
const MovePath = () => {
    ...
    const PopupScreen = () => {
        ...
        useEffect(() => {
            if (selectedPointIndex !== -1 && selectedPath) {
                localStorage.setItem('runningPathId', selectedPath.id);
                localStorage.setItem('runningPointIndex', selectedPointIndex);
            }
